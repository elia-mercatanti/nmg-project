...
\lstinputlisting[label=code:BSpline_base_surface, style=Matlab-editor, caption=Base delle superfici B-Spline, basicstyle =\footnotesize\ttfamily ]{../b_spline_surface_base.m}
\begin{figure}[h!]
	\centering
...
\lstinputlisting[label=code:BSpline_surface, style=Matlab-editor, caption= Superficie B-Spline, basicstyle =\footnotesize\ttfamily ]{../b_spline_surface_tensor_product.m}
...
\lstinputlisting[label=code:BSplineSurfaceAffineTrans, style=Matlab-editor, caption= Trasformazione affine superficie B-Spline, basicstyle =\footnotesize\ttfamily ]{../b_spline_surface_affine_trans.m}
...
\lstinputlisting[label=code:BSpline_surface_DeBoor, style=Matlab-editor, caption= Rappresentazione superficie B-Spline mediante algoritmo di de Boor =\footnotesize\ttfamily ]{../b_spline_surface_de_boor.m}
\begin{figure}[h!]
	\centering
