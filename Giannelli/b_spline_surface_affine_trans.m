...
origin_pol_plot = plot3(control_grid_x, control_grid_y, control_grid_z, ...
...
trasf_pol_plot = plot3(control_grid_x, control_grid_y, control_grid_z, ...
                       'r.-', 'linewidth', 2, 'MarkerSize', 25); 
plot3(control_grid_x.', control_grid_y.', control_grid_z.', 'r-', ...
      'linewidth', 2);
...
trasf_surf_pol_plot = plot3(control_grid_x, control_grid_y, ...
                            control_grid_z, 'c.--', 'linewidth', 2, ...
                            'MarkerSize', 25); 
plot3(control_grid_x.', control_grid_y.', control_grid_z.', 'c--', ...
      'linewidth', 2);
axis tight;
axis equal;
