...
- ### Excercise 3
    Finds control points in the BÃ©zier representation of the parametric 
...
- ### Excercise 6
    Takes as input the coordinates of the control polygon of a cubic Bézier
    curve use the degree elevation algorithm to find the control polygons
    of this curve elevated to 4, 5, 6 degrees and draws them.
